...
def train(train_loader, model, optimizer, criterion, regularizer=None, lr_schedule=None,pgdtype='0',curveflag=False,epoch=1):
    loss_sum = 0.0
    correct = 0.0
    #print(pgd)
    ...
    for iter, (input, target) in enumerate(train_loader):
        ...
        # torch.cuda.synchronize()
        # b = time.time()
        # print(f"Updating parameters costs {b - a}")
...
def test(test_loader, model, criterion, regularizer=None, pgdtype='0',curveflag=False):
    loss_sum = 0.0
    nll_sum = 0.0
    correct = 0.0
